  ...
  <div>
    ...
    <div class="container mx-auto p-6" style="margin-top: 5rem;">
      <div class="catalog-carddd p-3 mb-2 py-4">
        <div>
          <p class="mt-3" style="color: #658099; letter-spacing: 1.4px; font-size: 14px; font-weight: 300">Название
            <span class="px-2">/</span> Популярность <span class="px-2">/</span> Вид
          </p>
        </div>
        <div>
          <p class="mt-3" style="color: #658099; letter-spacing: 1.4px; font-size: 15px; font-weight: 300"><span
