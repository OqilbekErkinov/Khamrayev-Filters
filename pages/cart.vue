  ...
  <div class="container mx-auto p-6">
    ...
    <div class="" style="position: relative;">
      <div class="korzina-carddd p-3" style="display: flex; position: absolute; top: -50px;">
        ...
        <div>
          <p style="font-weight: 100; font-size: 14px; margin-left: 200px; margin-top: 15px">Имя</p>
        </div>
        <div>
          <p style="font-weight: 100; font-size: 14px; margin-left: 260px; margin-top: 15px">Вид</p>
        </div>
        <div>
          <p style="font-weight: 100; font-size: 14px; margin-left: 220px; margin-top: 15px">Производитель</p>
        </div>
        <div class="">
          <p></p>
        </div>
      </div>
      <div v-for="product in products" :key="product.id" class="korzina-card p-3 mb-2"
        style="display: flex; justify-content: space-between">
        <img :src="product.image" :alt="product.name" class="mb-3" style="width: 90px; height: 60px;" />
        <div class="ml-4 flex-1" style="margin-left: -50px;">
